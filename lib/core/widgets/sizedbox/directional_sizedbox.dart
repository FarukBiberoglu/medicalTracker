...
class DirectionalSizedBox extends StatelessWidget {
  ...
  const DirectionalSizedBox.expand(
  ...
  Widget build(BuildContext context) {
    ...
    return _RawDirectionalSizedBox(
      mainAxisExtent,
...
class _RawDirectionalSizedBox extends LeafRenderObjectWidget {
  const _RawDirectionalSizedBox(
      this.mainAxisExtent, {
        this.crossAxisExtent,
        this.color,
  ...
  RenderObject createRenderObject(BuildContext context) {
    return RenderDirectionalSizedBox(
  ...
  @override
  void updateRenderObject(BuildContext context, RenderDirectionalSizedBox renderObject) {
    renderObject
      ..mainAxisExtent = mainAxisExtent
      ..crossAxisExtent = crossAxisExtent ?? 0
      ..color = color
...
class RenderDirectionalSizedBox extends RenderBox {
  RenderDirectionalSizedBox({
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    ...
    if (direction != null) {
      ...
      throw FlutterError(
        'A DirectionalSizedBox widget must be placed directly inside a Flex widget '
