...
class RandevuCard extends StatelessWidget {
  ...
  const RandevuCard({super.key, required this.randevuModel});
                          ...
                          children: [
                            if (randevuModel.categoryEnum == CategoryEnum.upcoming) ...[
                              ListTile(
                                ...
                                onTap: () {
                                  context.read<RandevuCubit>().completed(randevuModel);
                              ...
                              ListTile(
                                ...
                                onTap: () {
                                  context.read<RandevuCubit>().canceled(randevuModel);
                                  Navigator.pop(context);
                                },
                              ),
                            ],
                            ListTile(
                              ...
                              onTap: () {
                                context.read<RandevuCubit>().deleteRandevu(randevuModel);
                                Navigator.pop(context);
                              },
                            ),
                          ],
