            ...
            child: Column(
              children: [
                ...
                _buildTextField(
                  ...
                  onChanged: cubit.lastName,
                ),
                const SizedBox(height: 12),
                _buildTextField(
                  hint: 'Disease',
                  icon: Icons.medical_services,
                  controller: cubit.diseaseController,
                  onChanged: cubit.disease,
                ),
                const SizedBox(height: 12),
                _buildTextField(
                  hint: 'Age',
                  ...
                  onChanged: (value) => cubit.userAge(int.tryParse(value) ?? 0),
                ),
                const SizedBox(height: 12),
                _buildTextField(
                  hint: 'Weight',
                  ...
                  onChanged: (value) => cubit.userWeight(int.tryParse(value) ?? 0),
                ),
                const SizedBox(height: 12),
                _buildTextField(
                  hint: 'Height',
                  ...
                  onChanged: (value) => cubit.userHeight(int.tryParse(value) ?? 0),
                ),
                const SizedBox(height: 12,),
                _buildTextField(
                  hint: 'Location',
