...
class DoctorChatDetailView extends StatefulWidget {
  final String receiverId;
  final String receiverName;
  const DoctorChatDetailView({
    super.key,
  ...
  @override
  State<DoctorChatDetailView> createState() => _DoctorChatDetailViewState();
}

class _DoctorChatDetailViewState extends State<DoctorChatDetailView> {
